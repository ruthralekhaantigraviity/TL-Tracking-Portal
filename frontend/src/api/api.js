...
export const getAdminActivity = async (date) => {
    try {
        const response = await axios.get(`${API_URL}/admin/activity/${date}`);
        return response.data;
    } catch (error) {
...
export const saveAdminActivity = async (content, date) => {
    try {
        const response = await axios.post(`${API_URL}/admin/activity`, { content, date });
        return response.data;
    } catch (error) {
